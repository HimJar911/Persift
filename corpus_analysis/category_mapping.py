...
_MAPPINGS = [
    ...
    Mapping("consent_demographic_survey", "consent_demographic_survey", "POLICY-backed capability — extension/consent_policy.js answers it (default: decline, voluntary demographic/diversity survey participation). Corpus showed this as a one-off (1 company, Myriad360) when the other 5 consent categories were built and was deliberately deferred then; added after a live test surfaced it as CLASSIFICATION_NO_MATCH. Distinct from consent_attestation_general — this is a clean participation-consent question, not contaminated with fact-based questions.", True),
