...
JOBVITE_FALLBACK_SLUGS = [
    "accenture", "adobe", "ancestry", "autodesk", "bain",
    "box", "broadcom", "cadence", "cisco", "citrix",
    "cloudera", "commvault", "corelogic", "costar", "dell",
    "docusign", "dropbox", "ebay", "electronic-arts", "equinix",
    "expedia", "f5", "fireeye", "fortinet", "garmin",
    "grubhub", "hp", "hpe", "ibm", "indeed",
    "infoblox", "intuit", "juniper", "kayak", "keysight",
    "linkedin", "logitech", "lyft", "mcafee", "medallia",
    "medidata", "micron", "microsoft", "netflix", "netscout",
    "nutanix", "nvidia", "palo-alto", "paylocity", "paypal",
    "pge", "pitchbook", "procore", "qualcomm", "ringcentral",
    "roku", "salesforce", "servicenow", "snap", "splunk",
    "sprinklr", "synopsys", "tableau", "teradata", "trimble",
    "twitch", "twitter", "verint", "verizon", "vmware",
    "walmart", "wish", "workday", "zendesk", "zillow",
]
